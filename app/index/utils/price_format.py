"""
This module contains a decorator that formats a price value to a
string with two.
"""


def price_formatter(func) -> callable:
    """A decorator that formats a price value to a string with two decimal
    places and commas as thousands separators.
...
def getting_price(price) -> str:
    ...
    Returns:
        A string with the formatted price value, with two decimal places
        and commas as thousands separators.
    """
    return price
